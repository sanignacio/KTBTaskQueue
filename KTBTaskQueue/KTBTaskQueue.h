...
/**
 Enqueue a task. See @c KTBTask.h for how to create tasks.
 The next Task will be attempted (almost) immediately via delegate or execution block.
 @param task The task to enqueue.
 */
- (void)enqueueTask:(KTBTask *)task;

/**
 Enqueue an array of tasks. See @c KTBTask.h for how to create tasks.
 The next Task will be attempted (almost) immediately via delegate or execution block.
 @param task The task to enqueue.
 */
...
/**
 Removes tasks in the queue with the given name and returns them in an array.
 @param name Name of task to look for in the queue.
 */
